...
```
"food", recipes, name, average cooking time(in minutes), rating(1 to 5)
...
| Record                | Properties          |
| --------------------- | ------------------  |
| recipes             | name, average cooking time(in minutes), rating(1 to 5)

Name of the table (always plural): `recipes` 

Column names: `name`, `average_cooking_time(minutes)`, `rating(1_to_5)`
...
id: SERIAL
name: text
average_cooking_time(minutes): int
rating(1_to_5): int
```
